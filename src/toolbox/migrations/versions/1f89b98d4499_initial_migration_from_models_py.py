...
Revision ID: 1f89b98d4499
Revises: 
Create Date: 2025-05-31 07:36:24.288218
...
def upgrade():
    ...
    op.create_table('sql_map_scan_results',
    sa.Column('id', sa.Integer(), nullable=False),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('user')
    op.drop_table('sql_map_scan_results')
